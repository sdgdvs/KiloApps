...
| KFreecell  | Tier 1          | Game Content Expander  | Loop 6 Completed | Full parity. Loop 6 completed: Expanded Campaign to 15 stages, added King-only empty tableau mechanic, Magic Wand & Extra Cell powerups, Time Attack Mode. |
...
| KReversi   | Tier 1          | Game Content Expander  | Loop 6 Completed | Full parity. Loop 6 completed: Expanded Campaign to 15 stages, added blocked/hole cells, 4 AI personalities (including Grandmaster Minimax), and Bomb Disc power-up. |
...
- [x] K2048 (Expanded Campaign Mode to 30 stages featuring dynamic board sizes 3x3 to 6x6, target tile goals 256 to 8192, move limits, Stage 30 8192 Grandmaster Challenge, Frozen/Bomb/Wildcard special tiles, Tile Upgrade [U], Grid Rotate [R], Tile Hammer [H], Free Undo [Z] active skills to both EXE and HTML)ive skills to both EXE and HTML)
