...
const char* CAT_WORDS[NUM_CATEGORIES][30] = {
    ...
    // 3: Movies
    {"JAWS", "ALIEN", "ROCKY", "AVATAR", "MATRIX", "TITANIC", "BATMAN", "PSYCHO", "GLADIATOR", "INCEPTION", "GODFATHER", "TERMINATOR", "JURASSIC", "SUPERMAN", "SPIDERMAN", "AVENGERS", "PREDATOR", "CASABLANCA", "GHOSTBUSTERS", "HALLOWEEN", "INTERSTELLAR", "GOODFELLAS", "BRAVEHEART", "RATATOUILLE", "OPPENHEIMER", "PULPFICTION", "GOODWILLHUNTING", "PIRATESCARIBBEAN", "SCHINDLERLIST", "BLADERUNNER"},
    // 4: Tech
    {"BYTE", "DATA", "CODE", "WIRE", "CHIP", "ROUTER", "SERVER", "MEMORY", "BROWSER", "NETWORK", "COMPUTER", "SOFTWARE", "INTERNET", "HARDWARE", "DATABASE", "KEYBOARD", "MONITOR", "COMPILER", "PROCESSOR", "VARIABLE", "FUNCTION", "APPLICATION", "DEVELOPER", "ALGORITHM", "MICROPROCESSOR", "CYBERSECURITY", "TELECOMMUNICATIONS", "SUPERCOMPUTER", "SUPERCONDUCTOR", "CRYPTOGRAPHY"},
    // 5: Myth
    {"ZEUS", "THOR", "LOKI", "HADES", "TITAN", "HYDRA", "SPHINX", "MEDUSA", "HERCULES", "ODYSSEY", "VALHALLA", "PEGASUS", "MINOTAUR", "POSEIDON", "ATHENA", "ANUBIS", "PHOENIX", "CENTAUR", "CHIMERA", "CERBERUS", "KRAKEN", "LEVIATHAN", "OUROBOROS", "BEHEMOTH", "VALKYRIE", "EXCALIBUR", "PROMETHEUS", "NEPTUNE", "HAMMERTHOR", "GARDENEDEN"},
    // 6: Food
    ...
    // 7: Literature
    {"NOVEL", "POEM", "BARD", "ILIAD", "HOMER", "UTOPIA", "HAMLET", "MACBETH", "ORWELL", "GATSBY", "POETRY", "MONTAGUE", "INFERNO", "BEOWULF", "DICKENS", "TOLKIEN", "DRACULA", "SHERLOCK", "SHAKESPEARE", "FRANKENSTEIN", "ODYSSEY", "MYTHOLOGY", "BIOGRAPHY", "ENCYCLOPEDIA", "WARANDPEACE", "CRIMEANDPUNISHMENT", "GREATGATSBY", "MOBYDICK", "PRIDEPREJUDICE", "LESMISERABLES"},
    // 8: Space
    {"MOON", "STAR", "MARS", "ORBIT", "COMET", "NEBULA", "METEOR", "COSMOS", "ASTEROID", "EXOPLANET", "BLACKHOLE", "GALAXY", "SATELLITE", "ECLIPSE", "TACHYON", "HUBBLE", "QUASAR", "PULSAR", "PARSEC", "GRAVITY", "SUPERNOVA", "LIGHTYEAR", "CONSTELLATION", "ASTROPHYSICS", "EXOSPHERE", "PLANETARIUM", "INTERSTELLAR", "SOLARSYS", "EVENTHORIZON", "MICROGRAVITY"},
    // 9: Sports
    {"GOLF", "BOXING", "RUGBY", "TENNIS", "SOCCER", "HOCKEY", "RACING", "SKIING", "BASEBALL", "FOOTBALL", "CRICKET", "SWIMMING", "WRESTLING", "CYCLING", "ARCHERY", "FENCING", "SURFING", "MARATHON", "BASKETBALL", "VOLLEYBALL", "BADMINTON", "GYMNASTICS", "SKATEBOARDING", "SNOWBOARDING", "WEIGHTLIFTING", "BOBSLEDDING", "WATERPOLO", "TRACKANDFIELD", "BODYBUILDING", "TRIATHLON"}
};
...
const CampaignStage CAMPAIGN_STAGES[20] = {
    ...
    {6,  5, "Stage 6: Mythic Lore", "Myth", 5, 8, 5},
    {7,  6, "Stage 7: Gourmet Bistro", "Food", 6, 9, 5},
    {8,  7, "Stage 8: Literary Master", "Literature", 6, 9, 5},
    {9,  8, "Stage 9: Cosmic Voyage", "Space", 6, 9, 5},
    {10, 9, "Stage 10: Arena Champion", "Sports", 6, 9, 5},
    {11, 0, "Stage 11: Wild Fauna", "Animals", 7, 10, 4},
    {12, 1, "Stage 12: Quantum Realm", "Science", 8, 11, 4},
    {13, 2, "Stage 13: Global Frontier", "Countries", 8, 11, 4},
    {14, 3, "Stage 14: Blockbuster Vault", "Movies", 8, 12, 4},
    {15, 4, "Stage 15: Cyber Core", "Tech", 9, 12, 4},
    {16, 5, "Stage 16: Olympian Pantheon", "Myth", 9, 13, 3},
    {17, 6, "Stage 17: Culinary Perfection", "Food", 9, 13, 3},
    {18, 7, "Stage 18: Great Classics", "Literature", 10, 14, 3},
    {19, 8, "Stage 19: Deep Galaxy", "Space", 10, 14, 3},
    {20, -1, "Stage 20: Polymath Grandmaster", "Polymath", 10, 14, 3}
};
