...
const APPS = [
  ...
  { id: 'kterm', title: 'KTerm', url: '/apps/kterm.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kterm.ico', w: 800, h: 600, folder: 'System' },
  ...
  { id: 'kcontacts', title: 'KContacts', url: '/apps/kcontacts.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kcontacts.ico', w: 800, h: 600, folder: 'System' },
