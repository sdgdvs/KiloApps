...
const APPS = [
  ...
  { id: 'kstarforge', title: 'KStarForge', url: '/apps/kstarforge.html', exeUrl: '/exe/KStarForge.exe', icon: '/assets/icons/kstarforge.ico', w: 1120, h: 760, folder: 'Games' },
