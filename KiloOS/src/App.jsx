...
const APPS = [
  ...
  { id: 'kcalc', title: 'KCalc', url: '/apps/kcalc.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kcalc.ico', w: 380, h: 520, folder: 'System' },
  ...
  { id: 'kread', title: 'KRead', url: '/apps/kread.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kread.ico', w: 750, h: 600, folder: 'System' },
