...
const APPS = [
  ...
  { id: 'kradio', title: 'KRadio', url: '/apps/kradio.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kradio.ico', w: 400, h: 250, folder: 'Media' },
  ...
  { id: 'kcolony', title: 'KColony', url: '/apps/kcolony.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kcolony.ico', w: 850, h: 650, folder: 'Games' },
  ...
  { id: 'kdragon', title: 'KDragon', url: '/apps/kdragon.html', exeUrl: '/exe/KApps.zip', icon: '/assets/icons/kdragon.ico', w: 600, h: 500, folder: 'Games' },
