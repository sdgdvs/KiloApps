# Architecture Overview for KiloOS
...
The **KiloOS** runtime loads the bundled JavaScript directly from the HTML file, so no external dependencies are required at runtime.
