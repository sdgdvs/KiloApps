...
def generate_colony():
    img = new_img()
    rect(img, 2, 2, 29, 29, (10, 14, 28))
    for sx, sy in [(5, 5), (25, 6), (27, 11), (7, 13), (22, 14)]:
        img[sy][sx] = (220, 240, 255)
    rect(img, 3, 22, 28, 28, (175, 68, 38))
    rect(img, 3, 25, 28, 28, (130, 48, 26))
    line(img, 3, 22, 28, 22, (215, 95, 52))
    circle(img, 15, 18, 7, (45, 120, 155))
    circle(img, 15, 18, 6, (60, 175, 195))
    circle(img, 15, 19, 4, (40, 190, 85))
    circle(img, 13, 20, 3, (30, 150, 65))
    circle(img, 17, 20, 3, (55, 215, 110))
    rect(img, 7, 21, 23, 23, (165, 178, 192))
    rect(img, 13, 21, 17, 23, (70, 85, 105))
    line(img, 15, 7, 15, 11, (200, 210, 225))
    rect(img, 14, 6, 16, 6, (255, 55, 55))
    return img

def generate_farm():
    img = new_img()
    rect(img, 2, 2, 29, 15, (135, 200, 245))
    circle(img, 25, 6, 3, (255, 225, 75))
    rect(img, 2, 16, 29, 29, (95, 175, 65))
    rect(img, 2, 22, 29, 29, (65, 145, 45))
    line(img, 2, 16, 29, 16, (130, 205, 85))
    rect(img, 5, 13, 17, 24, (185, 42, 38))
    line(img, 4, 13, 11, 8, (250, 250, 250))
    line(img, 11, 8, 18, 13, (250, 250, 250))
    line(img, 5, 13, 11, 9, (145, 30, 28))
    line(img, 11, 9, 17, 13, (145, 30, 28))
    rect(img, 10, 11, 12, 13, (60, 30, 20))
    rect(img, 10, 10, 12, 10, (250, 250, 250))
    rect(img, 8, 17, 14, 24, (125, 28, 25))
    line(img, 8, 17, 14, 24, (245, 245, 245))
    line(img, 8, 24, 14, 17, (245, 245, 245))
    for y in range(18, 27):
        img[y][22] = (205, 155, 25)
        img[y][24] = (205, 155, 25)
    for wx, wy in [(21, 16), (22, 15), (22, 17), (23, 14), (24, 15), (24, 17), (25, 16)]:
        if 0 <= wy < 32 and 0 <= wx < 32:
            img[wy][wx] = (255, 215, 55)
    return img

def generate_wizard():
    img = new_img()
    rect(img, 2, 2, 29, 29, (22, 14, 40))
    rect(img, 10, 5, 13, 6, (110, 48, 152))
    rect(img, 11, 7, 14, 8, (120, 52, 165))
    rect(img, 11, 9, 16, 11, (110, 48, 152))
    rect(img, 10, 12, 18, 15, (98, 42, 138))
    rect(img, 9, 16, 20, 18, (120, 52, 165))
    rect(img, 5, 19, 23, 21, (85, 34, 120))
    line(img, 5, 19, 23, 19, (145, 75, 195))
    line(img, 9, 18, 20, 18, (240, 185, 30))
    rect(img, 14, 17, 16, 19, (255, 230, 90))
    line(img, 27, 27, 22, 22, (125, 80, 40))
    circle(img, 21, 21, 2, (0, 240, 255))
    img[21][21] = (255, 255, 255)
    for mx, my, c in [
        (18, 14, (0, 255, 255)), (25, 18, (255, 65, 220)),
        (23, 25, (0, 240, 255)), (6, 9, (255, 225, 90)),
        (26, 8, (255, 65, 220))
    ]:
        img[my][mx] = c
    return img
...
def generate_void():
    img = new_img()
    rect(img, 2, 2, 29, 29, (2, 2, 8))
    for sx, sy in [(5, 5), (26, 6), (6, 26), (27, 25)]:
        img[sy][sx] = (160, 180, 255)
    circle(img, 15, 16, 11, (80, 25, 120))
    circle(img, 15, 16, 9, (160, 40, 190))
        ...
        for x in range(3, 29):
            ...
            if dx*dx + dy*dy <= 1.0:
                if y == 16:
                    ...
                    img[y][x] = (210, 35, 165)
    circle(img, 15, 16, 5, (0, 0, 0))
    import math
    for a in range(360):
        rx = int(15 + 6 * math.cos(math.radians(a)))
        ry = int(16 + 6 * math.sin(math.radians(a)))
        if 0 <= ry < 32 and 0 <= rx < 32 and img[ry][rx] != (0, 0, 0):
            if a % 3 == 0:
                img[ry][rx] = (0, 240, 255)
    return img
...
def generate_dragon():
    img = new_img()
    rect(img, 2, 2, 29, 29, (25, 20, 22))
    rect(img, 4, 16, 12, 27, (165, 24, 28))
    rect(img, 5, 18, 10, 27, (120, 15, 18))
    rect(img, 8, 11, 16, 17, (195, 32, 36))
    rect(img, 13, 14, 18, 18, (215, 40, 45))
    line(img, 11, 11, 5, 5, (235, 175, 35))
    line(img, 10, 12, 6, 6, (255, 220, 90))
    img[13][12] = (255, 215, 0)
    img[13][13] = (40, 10, 10)
    img[17][16] = (255, 255, 255)
    img[18][17] = (255, 255, 255)
    for fx, fy in [
        (19, 15), (20, 15), (21, 14), (22, 14), (23, 13), (24, 13), (25, 12), (26, 12), (27, 11),
        (19, 16), (20, 16), (21, 16), (22, 15), (23, 15), (24, 14), (25, 14), (26, 13), (27, 13), (28, 12),
        (19, 17), (20, 17), (21, 17), (22, 17), (23, 16), (24, 16), (25, 15), (26, 15), (27, 14), (28, 14),
        (20, 18), (21, 18), (22, 18), (23, 17), (24, 17), (25, 16), (26, 16), (27, 15),
        (21, 19), (22, 19), (23, 18), (24, 18), (25, 17)
    ]:
        if 0 <= fy < 32 and 0 <= fx < 32:
            img[fy][fx] = (255, 105, 20)
    for fx, fy in [
        (20, 16), (21, 16), (22, 16), (23, 15), (24, 15), (25, 14),
        (21, 17), (22, 17), (23, 16), (24, 16), (22, 18)
    ]:
        if 0 <= fy < 32 and 0 <= fx < 32:
            img[fy][fx] = (255, 235, 60)
    img[16][21] = (255, 255, 255)
    img[17][22] = (255, 255, 255)
    return img

def generate_mech():
    img = new_img()
    rect(img, 2, 2, 29, 29, (30, 34, 42))
    rect(img, 4, 12, 9, 24, (88, 102, 118))
    rect(img, 22, 12, 27, 24, (88, 102, 118))
    rect(img, 4, 12, 9, 13, (120, 138, 158))
    rect(img, 22, 12, 27, 13, (120, 138, 158))
    rect(img, 9, 16, 22, 28, (110, 125, 140))
    rect(img, 10, 17, 21, 27, (90, 105, 120))
    rect(img, 11, 7, 20, 16, (135, 150, 165))
    rect(img, 12, 8, 19, 9, (165, 180, 195))
    rect(img, 12, 11, 19, 12, (0, 245, 255))
    img[11][15] = (255, 255, 255)
    img[11][16] = (255, 255, 255)
    for rx, ry in [(5, 15), (7, 15), (5, 19), (7, 19)]:
        rect(img, rx, ry, rx+1, ry+1, (235, 45, 45))
    for h in range(15, 23):
        col = (255, 205, 25) if (h % 2 == 0) else (25, 25, 30)
        line(img, 23, h, 26, h, col)
    rect(img, 13, 22, 18, 24, (45, 52, 60))
    line(img, 14, 23, 17, 23, (80, 92, 105))
    return img

def generate_cyber():
    img = new_img()
    rect(img, 2, 2, 29, 29, (8, 12, 24))
    line(img, 3, 28, 28, 28, (15, 75, 95))
    line(img, 4, 25, 27, 25, (15, 75, 95))
    line(img, 6, 22, 25, 22, (15, 75, 95))
    line(img, 15, 16, 4, 29, (0, 180, 210))
    line(img, 16, 16, 27, 29, (0, 180, 210))
    line(img, 15, 16, 15, 29, (0, 180, 210))
    rect(img, 11, 6, 20, 16, (18, 28, 48))
    rect(img, 11, 6, 20, 6, (0, 255, 125))
    rect(img, 11, 6, 11, 16, (0, 255, 125))
    rect(img, 20, 6, 20, 16, (0, 255, 125))
    rect(img, 13, 16, 18, 16, (0, 255, 125))
    rect(img, 13, 9, 14, 10, (0, 255, 255))
    rect(img, 17, 9, 18, 10, (0, 255, 255))
    line(img, 5, 5, 10, 5, (255, 0, 145))
    line(img, 10, 5, 10, 8, (255, 0, 145))
    line(img, 26, 5, 21, 5, (0, 255, 255))
    line(img, 21, 5, 21, 8, (0, 255, 255))
    line(img, 5, 18, 8, 18, (0, 255, 125))
    line(img, 23, 18, 26, 18, (0, 255, 125))
    img[13][15] = (255, 220, 40)
    img[14][16] = (255, 50, 50)
    return img

def generate_trader():
    img = new_img()
    rect(img, 2, 2, 29, 29, (12, 16, 32))
    for sx, sy in [(5, 5), (27, 4), (6, 26), (28, 24)]:
        img[sy][sx] = (210, 230, 255)
    import math
    for deg in range(15, 80):
        ox = int(16 + 14 * math.cos(math.radians(deg)))
        oy = int(16 - 12 * math.sin(math.radians(deg)))
        if 0 <= oy < 32 and 0 <= ox < 32:
            img[oy][ox] = (235, 185, 35)
    rect(img, 21, 13, 26, 17, (180, 195, 215))
    rect(img, 24, 14, 26, 16, (255, 195, 45))
    rect(img, 10, 14, 21, 16, (95, 105, 120))
    rect(img, 11, 10, 15, 13, (245, 125, 28))
    rect(img, 16, 10, 20, 13, (0, 210, 235))
    rect(img, 13, 17, 18, 20, (230, 185, 25))
    rect(img, 8, 12, 10, 18, (70, 78, 90))
    line(img, 4, 13, 7, 13, (0, 240, 255))
    line(img, 4, 17, 7, 17, (0, 240, 255))
    img[13][6] = (255, 255, 255)
    img[17][6] = (255, 255, 255)
    return img

def generate_mystery():
    img = new_img()
    rect(img, 2, 2, 29, 29, (26, 24, 34))
    for y in range(2, 14):
        for x in range(2, 16):
            if (x - 2) + (y - 2) <= 10:
                img[y][x] = (55, 48, 42)
    img[3][3] = (255, 220, 100)
    for cx, cy in [(12, 14), (13, 13), (14, 13), (15, 14), (15, 15), (14, 16), (13, 16), (14, 17)]:
        img[cy][cx] = (150, 210, 245)
    circle(img, 15, 15, 7, (225, 180, 45))
    circle(img, 15, 15, 5, (45, 50, 68))
    for cx, cy in [(13, 14), (14, 13), (15, 14), (16, 15), (15, 16), (14, 16)]:
        img[cy][cx] = (195, 235, 255)
    line(img, 12, 11, 16, 11, (255, 255, 255))
    img[12][11] = (255, 255, 255)
    line(img, 20, 20, 22, 22, (225, 180, 45))
    line(img, 23, 23, 28, 28, (115, 52, 24))
    line(img, 22, 24, 27, 29, (85, 38, 18))
    return img

def generate_stellar():
    img = new_img()
    rect(img, 2, 2, 29, 29, (4, 4, 14))
    for sx, sy in [(5, 6), (26, 7), (6, 25), (25, 25), (8, 12), (23, 19)]:
        img[sy][sx] = (190, 210, 255)
    for gx, gy in [
        (16, 15), (17, 14), (19, 13), (21, 13), (23, 15), (24, 17), (23, 19), (21, 21)
    ]:
        if 0 <= gy < 32 and 0 <= gx < 32:
            img[gy][gx] = (65, 195, 255)
    for gx, gy in [
        (15, 17), (14, 18), (12, 19), (10, 19), (8, 17), (7, 15), (8, 13), (10, 11)
    ]:
        if 0 <= gy < 32 and 0 <= gx < 32:
            img[gy][gx] = (225, 75, 210)
    circle(img, 15, 16, 2, (255, 255, 220))
    img[16][15] = (255, 255, 255)
    line(img, 15, 4, 15, 7, (240, 195, 45))
    line(img, 15, 25, 15, 28, (240, 195, 45))
    line(img, 4, 16, 7, 16, (240, 195, 45))
    line(img, 25, 16, 28, 16, (240, 195, 45))
    img[6][6] = (0, 210, 235)
    img[6][7] = (0, 210, 235)
    img[7][6] = (0, 210, 235)
    img[6][25] = (0, 210, 235)
...
new_games = [
    ("kcolony", generate_colony),
    ("kfarm", generate_farm),
    ("kwizard", generate_wizard),
    ("kvoid", generate_void),
    ("kdragon", generate_dragon),
    ("kmech", generate_mech),
    ("kcyber", generate_cyber),
    ("ktrader", generate_trader),
    ("kmystery", generate_mystery),
    ("kstellar", generate_stellar)
]

for name, gen in new_games:
    save_ico(f"icons/{name}.ico", gen())
    save_ico(f"KiloOS/public/assets/icons/{name}.ico", gen())
