...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch (msg) {
        ...
        case WM_CREATE: {
            ...
            tie.pszText = "Document 2";
            SendMessage(hTab, TCM_INSERTITEMA, 1, (LPARAM)&tie);
